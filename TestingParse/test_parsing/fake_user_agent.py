...
# Можно передавать тип браузера

# ua = UserAgent(os='linux')
#Можно передавать операционку

# Когда вы задаете значение для min_percentage, библиотека будет возвращать только те User-Agent, доля использования
# которых равна или превышает указанный процент.
